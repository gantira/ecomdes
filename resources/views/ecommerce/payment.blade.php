...
@section('title')
    <title>Konfirmasi Pembayaran - {{ env('APP_NAME') }}</title>
@endsection
                                    ...
                                    <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="transfer_to" class="form-control" required>
                                                ...
                                                <option value="BCA - 1234567">BCA: 1234567 a.n Ecomdes</option>
                                                <option value="Mandiri - 2345678">Mandiri: 2345678 a.n Ecomdes</option>
                                                <option value="BRI - 9876543">BCA: 9876543 a.n Ecomdes</option>
                                                <option value="BNI - 6789456">BCA: 6789456 a.n Ecomdes</option>
                                            </select>
