			...
			<div class="container-fluid">
				...
				<div class="float-right">
					<ul class="right_side">
						...
						<li><a href="{{ route('home') }}">Mitra</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
						{{-- <img src="https://daengweb.id/front/dw-theme/images/logo-head.png" alt=""> --}} {{ env('APP_NAME') }}
					</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget ">
                        ...
                        <img src="{{ asset('ecommerce/img/unikom.png') }}" alt="unikom" width="100px" >
                        <img src="{{ asset('ecommerce/img/smartasset.jpeg') }}" alt="smartasset" width="100px" >
                        <img src="{{ asset('ecommerce/img/ristekdikti.png') }}" alt="ristekdikti" width="100px" >
                        <img src="{{ asset('ecommerce/img/bmw.jpeg') }}" alt="bmw" width="100px" >
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
            ...
            <div class="row footer-bottom d-flex justify-content-between align-items-center">
                <p class="col-lg-12 footer-text text-center">
                    ...
                    <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="{{ env('APP_URL') }}"
